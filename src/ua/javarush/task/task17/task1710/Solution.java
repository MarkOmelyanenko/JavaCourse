...
public class Solution {
    ...
    static {
        ...
        allPeople.add(Person.createMale("Петренко Петро", new Date()));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (args[0]) {
            ...
            case "-r":
                ...
                if (person != null) {
                    System.out.println(person.getName() + " " + (person.getSex() == Sex.MALE ? "ч" : "ж") + " " + simpleDateFormat2.format(person.getBirthDate()));
                }
                break;
            case "-u":
    ...
    private static Sex getSex(String sexParam) {
        return sexParam.equals("ч") ? Sex.MALE : Sex.FEMALE;
    }
}
